...
while True:
    ...
    if password in used_pass and password != "random":
       print('ERROR - This password has been used before, please enter a new one.')
        ...
        if password == "random":
                ...
                break
##        for i in password:
##            if not i.isalnum() and i.islower() and i.isupper() and i.isdigits():
##                special = lower = numbers = upper = True
##            if special and lower and numbers and upper:
##                break
##        if special and lower and numbers and upper:
##        if password is lower_case and password is upper_case and password is special_c and password is all_characters:
##            special = lower = numbers = upper = True
##        if special and lower and numbers and upper:
            if 1 < len(password) < 8:
                print(len(password)*'*')
            ...
            print('ERROR!')
            print('Password must have atleast 8 characters and contain: UPPERCASE, lowercase, numbers and special characters.')
else:
    False
